...
import * as solution from "./encoding-comparison-lab.solution";

describe("encoding-comparison-lab 模範解答", () => {
  it("graderで全テストにpassする", () => {
    const yamlPath = path.join(__dirname, "..", "encoding-comparison-lab.yaml");
