...
import * as solution from "./mini-mapreduce-wordcount-lab.solution";

describe("mini-mapreduce-wordcount-lab 模範解答", () => {
  it("graderで全テストにpassする", () => {
    const yamlPath = path.join(__dirname, "..", "mini-mapreduce-wordcount-lab.yaml");
