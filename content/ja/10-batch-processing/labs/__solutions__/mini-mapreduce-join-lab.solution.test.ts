...
import * as solution from "./mini-mapreduce-join-lab.solution";

describe("mini-mapreduce-join-lab 模範解答", () => {
  it("graderで全テストにpassする", () => {
    const yamlPath = path.join(__dirname, "..", "mini-mapreduce-join-lab.yaml");
